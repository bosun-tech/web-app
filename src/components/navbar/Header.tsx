			...
			<nav>
				...
				<div className="hidden space-x-8 lg:flex flex-row justify-between items-center">
					...
					<div className="flex flex-row justify-between items-center space-x-3">
						<button className="bg-[#2194F2] hover:bg-blue-600 text-white font-bold py-2 px-4 rounded-xl cursor-not-allowed">
							Connect
						</button>
						<button className="bg-[#F0F2F5] hover:bg-[#AAAAAA] hover:text-white text-[#121417] font-bold py-2 px-4 rounded-xl w-[83px] text-ellipsis overflow-hidden whitespace-nowrap">
							GC3ITN4WA277YQE4C45QHJOEMBKSQO2YIQYO3FY4E4D26UVAOOY4F53C
						</button>

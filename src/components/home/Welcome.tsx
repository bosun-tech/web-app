		...
		<div className="relative w-full">
			...
			<div className="z-20 flex flex-col md:flex-row items-center justify-center lg:justify-between h-screen p-4 px-[16px] mt-22 relative md:p-0 md:w-full">
				<div className="flex flex-col items-center md:items-start text-center md:text-left md:max-w-[90%] lg:max-w-[50%]">
					<h3 className="text-[48px] xs:max-w-[355px]  md:w-full font-semibold font-inter font-bold tracking-tighter px-4 md:p-0 leading-10  md:text-[83px]  md:font-semibold md:leading-[75px]">
						Seamlessly Discover and Interact with Stellar Anchors
					</h3>
					<p className="text-gray-500 text-center md:text-left px-2 text-[14px] mt-8 max-w-[282px] md:w-full font-regular md:text-[18.5px] md:max-w-[475px]">
					...
					<div>
						...
						<button className="bg-[#2194F2] hover:bg-blue-600 text-white font-bold py-2 px-8 rounded-xl w-full md:w-auto mt-4 text-[20px]	font-inter font-semibold h-12	mt-8 hidden md:block">
							Start Exploring Anchors
						</button>
					</div>
				</div>
				<img
					className="hidden lg:block md:w-[25%] lg:w-[35%]"
					src={bosunLogo}
					alt="Bosun Logo"
				/>
			</div>
